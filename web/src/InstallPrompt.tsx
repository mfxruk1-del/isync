    ...
    <>
      <div className="mb-4 flex items-center justify-between gap-3 rounded-xl border border-emerald-400/30 bg-emerald-400/10 px-4 py-3">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-slate-200">Install Vault for the best experience.</span>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label="Dismiss"
            className="rounded-lg px-2 py-1.5 text-slate-400 hover:bg-white/5"
          >
            ✕
          </button>
        </div>
      ...
      {showIosHelp && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-2xl border border-white/10 bg-panel p-6 text-center"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="text-3xl">📲</div>
            <h2 className="mt-2 text-lg font-semibold">Add to Home Screen</h2>
            <ol className="mt-4 space-y-2 text-left text-sm text-slate-300">
              <li>
                1. Tap the <strong>Share</strong> button{' '}
                <span className="text-slate-400">(the square with an arrow)</span> in Safari.
              </li>
              <li>
